...
type WipeeRepository interface {
...
type WipeeDao struct {
	DB     dynamodbiface.DynamoDBAPI
	Logger *log.Logger
}

func (m *WipeeDao) GetUserProfileByUserID(ctx context.Context, userProfileId string) (*models.UserProfile, error) {
...
func (m *WipeeDao) PostUserProfile(ctx context.Context, userProfile *models.UserProfile) error {
	return nil
}

func (m *WipeeDao) GetUserProfileDuplicated(ctx context.Context, userProfile *models.UserProfile) (*models.ListOfUsersProfile, error) {
...
func (m *WipeeDao) UpsertUserProfile(ctx context.Context, userProfile *models.UserProfile) error {
